...
class Slice():
    ...
    # NEEDS_REFACTOR
    def slice_arr3p(self, arr, p1=(0,0,0), p2=None, p3=None, clip_idx=False):
        if p3 is None:
        ...
        if print_debug:
            ...
            print(p2)
            print(p3)
            print(self.p3_to_normal_vec(p1,p2,p3))
    ...
    def save_slice_image(self, slice, dir="slice_img", filename="slice.png"):
        PIL_image = self.slice2image(slice)
