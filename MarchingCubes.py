...
class MarchingCubes():
	...
	@staticmethod
	def marching_cube_corners_from_centroid(centroid):
		"""
	...
	@staticmethod
	def triangle_corner_from_centroid(centroid, corner_idx):
		"""
		Returns slice-triangle corner coordinates
		corner indices:
		...
		:param centroid: centroid of Marching Cube coordinates
		:param corner_idx: corner id from the picture
		"""
		corner = (np.array(centroid) + np.array(MarchingCubes.Tringle_corner_offset_table[corner_idx])).tolist()
		return corner
